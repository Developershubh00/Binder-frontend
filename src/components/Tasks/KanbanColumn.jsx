...
// The "⋯" dropdown shown on each column header. The board is auto-sorted (by
// priority, then due date), so the menu only offers "Add task".
const ColumnMenu = ({ column, onAddTask }) => {
...
const KanbanColumn = ({ column, tasks, onTaskClick, onAddTask }) => (
  <div className="flex w-80 shrink-0 flex-col">
    ...
    <div className="mb-3 flex items-center justify-between px-1">
      ...
      <ColumnMenu column={column} onAddTask={onAddTask} />
    </div>
