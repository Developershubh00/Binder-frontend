              ...
              >
                ...
                >
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamSurplus`]}
                  >
                    <PercentInput
                      ...
                      placeholder="e.g., 3-5"
                      error={Boolean(errors[`${errorPrefix}_foamSurplus`])}
                    />
                  </Field>
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamWastage`]}
                  >
                      ...
                      <SearchableDropdown
                        ...
                        onChange={(selectedValue) => {
                          ...
                          if (predefinedOptions.includes(selectedValue)) {
                            ...
                            const numericValue = selectedValue.replace(
                              /[^0-9.]/g,
                              "",
                            );
                            handleChange(
                        ...
                        placeholder="Select or type %"
                        className={`${material.foamWastage && !["Yoga Mats", "Packaging", "Insoles", "Craft", "Protective Cases"].includes(material.foamWastage) ? "pr-10" : ""} ${errors[`${errorPrefix}_foamWastage`] ? "border-red-600" : ""}`}
                      />
                      {material.foamWastage &&
                        ![
                          "Yoga Mats",
                          "Packaging",
                          "Insoles",
              ...
              >
                ...
                >
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamPeEpeSurplus`]}
                  >
                    <PercentInput
                      ...
                      placeholder="e.g., 3-5"
                      error={Boolean(errors[`${errorPrefix}_foamPeEpeSurplus`])}
                    />
                  </Field>
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamPeEpeWastage`]}
                  >
                    <div className="relative">
                      <SearchableDropdown
                        ...
                        placeholder="Select or type %"
                        className={`${material.foamPeEpeWastage && !["Packaging", "Insulation", "Protective Wrap", "Underlayment"].includes(material.foamPeEpeWastage) ? "pr-10" : ""} ${errors[`${errorPrefix}_foamPeEpeWastage`] ? "border-red-600" : ""}`}
                      />
                      {material.foamPeEpeWastage &&
                        ![
                          ...
                          "Protective Wrap",
                          "Underlayment",
                        ].includes(material.foamPeEpeWastage) && (
                          <span
                            style={{
                              position: "absolute",
                              right: "0.875rem",
              ...
              <>
                ...
                >
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamPuSurplus`]}
                  >
                    <PercentInput
                      ...
                      placeholder="e.g., 3-5"
                      error={Boolean(errors[`${errorPrefix}_foamPuSurplus`])}
                    />
                  </Field>
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamPuWastage`]}
                  >
                    <div className="relative">
                      <SearchableDropdown
                        ...
                        placeholder="Select or type %"
                        className={`${material.foamPuWastage && !["Mattress Core", "Cushion Insert", "Topper", "Packaging"].includes(material.foamPuWastage) ? "pr-10" : ""} ${errors[`${errorPrefix}_foamPuWastage`] ? "border-red-600" : ""}`}
                      />
                      {material.foamPuWastage &&
                        ![
                          "Mattress Core",
                          "Cushion Insert",
                          "Topper",
                          "Packaging",
                        ].includes(material.foamPuWastage) && (
                          <span
                            style={{
                              position: "absolute",
                              right: "0.875rem",
              ...
              <>
                ...
                >
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamRebondedSurplus`]}
                  >
                    <PercentInput
                      ...
                      placeholder="e.g., 3-5"
                      error={Boolean(
                        errors[`${errorPrefix}_foamRebondedSurplus`],
                      )}
                    />
                  </Field>
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamRebondedWastage`]}
                  >
                    <div className="relative">
                      <SearchableDropdown
                        ...
                        placeholder="Select or type %"
                        className={`${material.foamRebondedWastage && !["Carpet Underlay", "Gym Mats", "Economy Mattress", "Packaging"].includes(material.foamRebondedWastage) ? "pr-10" : ""} ${errors[`${errorPrefix}_foamRebondedWastage`] ? "border-red-600" : ""}`}
                      />
                      {material.foamRebondedWastage &&
                        ![
                          "Carpet Underlay",
                          "Gym Mats",
                          "Economy Mattress",
                          "Packaging",
                        ].includes(material.foamRebondedWastage) && (
                          <span
                            style={{
                              position: "absolute",
                              right: "0.875rem",
                ...
                >
                  ...
                  >
                    ...
                    <Field
                      ...
                      required
                      width="sm"
                      error={errors[`${errorPrefix}_foamGelInfusedSurplus`]}
                    >
                      <PercentInput
                        ...
                        placeholder="e.g., 3-5"
                        error={Boolean(
                          errors[`${errorPrefix}_foamGelInfusedSurplus`],
                        )}
                      />
                    </Field>
                        ...
                        <SearchableDropdown
                          ...
                          className={
                            ...
                            ![
                              ...
                              "Premium Pillows",
                              "Hot Sleeper Products",
                            ].includes(material.foamGelInfusedWastage)
                              ? "pr-10"
                              : ""
                          }
                        />
                ...
                >
                  ...
                  >
                    ...
                    <Field
                      ...
                      required
                      width="sm"
                      error={errors[`${errorPrefix}_foamLatexSurplus`]}
                    >
                      <PercentInput
                        ...
                        placeholder="e.g., 2-5"
                        error={Boolean(
                          errors[`${errorPrefix}_foamLatexSurplus`],
                        )}
                      />
                    </Field>
                        ...
                        <SearchableDropdown
                          ...
                          className={
                            ...
                            ![
                              ...
                              "Organic Bedding",
                              "Premium Pillows",
                            ].includes(material.foamLatexWastage)
                              ? "pr-10"
                              : ""
                          }
                        />
                ...
                >
                  ...
                  >
                    ...
                    <Field
                      ...
                      required
                      width="sm"
                      error={errors[`${errorPrefix}_foamMemorySurplus`]}
                    >
                      <PercentInput
                        ...
                        placeholder="e.g., 3-5"
                        error={Boolean(
                          errors[`${errorPrefix}_foamMemorySurplus`],
                        )}
                      />
                    </Field>
                        ...
                        <SearchableDropdown
                          ...
                          className={
                            ...
                            ![
                              ...
                              "Mattress Layer",
                              "Cushion",
                            ].includes(material.foamMemoryWastage)
                              ? "pr-10"
                              : ""
                          }
                        />
              ...
              >
                ...
                >
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamHrSurplus`]}
                  >
                    <PercentInput
                      ...
                      placeholder="e.g., 3-5"
                      error={Boolean(errors[`${errorPrefix}_foamHrSurplus`])}
                    />
                  </Field>
                  ...
                  <Field
                    ...
                    required
                    width="sm"
                    error={errors[`${errorPrefix}_foamHrWastage`]}
                  >
                    <div className="relative">
                      <SearchableDropdown
                        ...
                        placeholder="Select or type %"
                        className={`${material.foamHrWastage && !["Premium Mattress", "Automotive Seating", "High-End Cushions"].includes(material.foamHrWastage) ? "pr-10" : ""} ${errors[`${errorPrefix}_foamHrWastage`] ? "border-red-600" : ""}`}
                      />
                      {material.foamHrWastage &&
                        ![
                          "Premium Mattress",
                          "Automotive Seating",
                          "High-End Cushions",
                        ].includes(material.foamHrWastage) && (
                          <span
                            style={{
                              position: "absolute",
                              right: "0.875rem",
