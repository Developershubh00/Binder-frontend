    ...
    <div className="fullscreen-content">
      <div className="content-header">
        ...
        <p className="fullscreen-description">
          View and manage all internal purchase order master records.
        </p>
      </div>
      ...
      >
        ...
        <p style={{ fontSize: 14, lineHeight: 1.5 }}>
          Once internal purchase orders are committed, they will appear here as a searchable master sheet.
        </p>
      </div>
    </div>
  );
