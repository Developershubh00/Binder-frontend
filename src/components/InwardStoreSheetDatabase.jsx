...
const InwardStoreSheetDatabase = ({ onBack, onOpenForm }) => {
  ...
  const typeLabel = (val) => {
    const map = {
      ...
      CHALLAN_CUM_INVOICE: "Challan Cum Invoice",
    };
    return map[val] || val;
  };
  ...
  const HEAD_COLS =
    "grid grid-cols-[1.4fr_1fr_1fr_1fr_auto] items-center gap-3";
                        ...
                        <div className="overflow-x-auto rounded-lg border border-[#e2e3e8] bg-card">
                          <table className="w-full table-fixed border-collapse text-sm">
                            <colgroup>
                              ...
                              <col
                                style={{
                                  width: isChallanOnly(sheet) ? "18%" : "13%",
                                }}
                              />
                              <col style={{ width: "8%" }} />
                              <col style={{ width: "8%" }} />
                              ...
                              <col
                                style={{
                                  width: isChallanOnly(sheet) ? "15%" : "11%",
                                }}
                              />
                              <col style={{ width: "10%" }} />
                              <col style={{ width: "6%" }} />
